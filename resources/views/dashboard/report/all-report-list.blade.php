            ...
            <ul class="ml-8 space-y-2 mt-2">
                <li>
                    <div class="cursor-pointer block max-w-full p-5 bg-gray-50 border-gray-200 rounded-lg border hover:bg-gray-100">
                        <p class="text-gray-700 font-battambang text-[16px] font-medium">គ្រឹះស្ថានឧត្តមសិក្សា សរុប</p>
                    </div>
                </li>
                <li>
                    <div class="cursor-pointer block max-w-full p-5 bg-gray-50 border-gray-200 rounded-lg border hover:bg-gray-100">
                        <p class="text-gray-700 font-battambang text-[16px] font-medium">គ្រឹះស្ថានឧត្តមសិក្សា​ សាធារណៈ</p>
                    </div>
                </li>
                <li>
                    <div class="cursor-pointer block max-w-full p-5 bg-gray-50 border-gray-200 rounded-lg border hover:bg-gray-100">
                        <p class="text-gray-700 font-battambang text-[16px] font-medium">គ្រឹះស្ថានឧត្តមសិក្សា ឯកជន</p>
                    </div>
                </li>
            </ul>
        </details>
