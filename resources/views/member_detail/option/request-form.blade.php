<div class="mx-[25%] bg-white px-8 py-8 mt-5 mb-5 hidden" id="request-form">
    ...
    <div class="foot mt-5 font-battambang text-gray-900">
        <p class="mt-2">
            <span class="ml-9">វិញ្ញាបនបត្រ</span>រដ្ឋបាលនេះ ចេញជូនសាមីខ្លួនសម្រាប់ប្រើប្រាស់តាមច្បាប់ដែលអាចប្រើទៅបាន
            និង
        </p>
        <p class="mt-2">
    ...
    <button
        class="word-request-btn text-white text-[17px] bg-[#4285F4] hover:bg-[#4285F4]/90 focus:ring-2 focus:outline-none rounded-xl px-4 py-2 text-center inline-flex items-center justify-between mr-2 mb-2"
