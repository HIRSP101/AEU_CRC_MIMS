    ...
    <div class="flex flex-col flex-1 overflow-y-auto">
        <nav class="flex-1 px-2 py-4 bg-white">
            ...
            <div class="mt-10">
                ...
                <a href="" id="dropdown_entry"
                    class="flex items-center font-siemreap px-4 py-2 mt-2 text-gray-800 font-semibold hover:bg-red-400 rounded">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-2 transition delay-100 duration-300"
                ...
                <div class="ml-5 dropdown_entry hidden">
                    <a href="{{ route('import') }}" class="module-content flex items-center font-siemreap px-4
                        py-2 mt-2 text-gray-800 font-semibold hover:bg-red-400 rounded">
                        + បញ្ជូលជា File
                    </a>
                ...
                <a href=""
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-2" width="28" height="28"
                        viewBox="0 0 30 30">
                        <path
