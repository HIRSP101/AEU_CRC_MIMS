        ...
        <div class="flex flex-wrap -mx-3 mt-3 mb-6">
            <div class="w-full md:w-1/4 px-3">
                ...
                <input
                    ...
                    id="village" type="text" id="village" required  value="{{$newMemberModel->village}}">
            </div>
            <div class="w-full md:w-1/4 px-3">
                ...
                <input
                    class="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-300 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                    id="commune" type="text" id="commune" required  value="{{$newMemberModel->member_pob_address->commune_sangkat}}">
            </div>
            <div class="w-full md:w-1/4 px-3">
                ...
                <input
                    class="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-300 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                    id="district" id="district" type="text" required  value="{{$newMemberModel->member_pob_address->district_khan}}">
            </div>
            <div class="w-full md:w-1/4 px-3">
                ...
                <input
                    class="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-300 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                    list="proviencelist" id="provience" type="text" required  value="{{$newMemberModel->provience_city}}">
