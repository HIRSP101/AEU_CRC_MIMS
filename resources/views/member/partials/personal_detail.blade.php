<div class="flex flex-wrap mx-3 mb-6">
    <div class="flex-1 w-full md:w-1/4 px-3 mb-6 md:mb-0">
        ...
        <input
            ...
            name="name_kh" id="name_kh" type="text" value="{{ old('name_kh', $member->name_kh ?? '') }}" placeholder="ឈ្មោះជាភាសាខ្មែរ" required>
    </div>
    <div class="flex-1 w-full md:w-1/4 px-3">
        ...
        <input
            ...
            name="name_en" id="name_en" type="text" value="{{ old('name_en', $member->name_en ?? '') }}" placeholder="ឈ្មោះជាភាសាអង់គ្លេស" required>
    </div>
    ...
    <div class="w-1/2 md:w-32 px-3">
        ...
        <input
            class="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-300 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
            name="nationality" id="nationality" type="text" value="{{ old('nationality', $member->nationality ?? '') }}" required>
    </div>
