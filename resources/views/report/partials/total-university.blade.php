                ...
                <table class="table-auto border-collapse border border-gray-700 w-full text-center text-sm">
                  ...
                  <thead>
                    <tr class="bg-gray-100">
                      ...
                      <th colspan="2" class="border border-gray-700 p-2 font-semibold font-battambang">ពិការភាព</th>
                      <th rowspan="2" class="border border-gray-700 p-2 font-semibold font-battambang">ចំនួនយុវជនទទួលវគ្គ បណ្ដុះបណ្ដាល មូលដ្ឋាន</th>
                      <th rowspan="2" class="border border-gray-700 p-2 font-semibold font-battambang">ចំនួនយុវជនបានទទួល ឯកសណ្ឋាន</th>
                    </tr>
                    <tr class="bg-gray-100">
