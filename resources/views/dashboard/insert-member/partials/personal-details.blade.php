<div class="flex flex-wrap -mx-3 mb-6">
    ...
    <div class="flex-1 w-full md:w-1/4 px-3">
        ...
        <input
            ...
            name="name_en" id="name_kh" type="text" placeholder="ឈ្មោះជាភាសាអង់គ្លេស" required>
    </div>
    ...
    <div class="w-1/2 md:w-44 px-3">
        ...
        <input
            class="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-300 rounded p-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
            name="image" type="file" id="image">
    </div>
</div>
<div class="flex flex-wrap -mx-3 mb-2 mt-5">
    <div class="w-40 md:w-56 px-3">
        <label class="block uppercase tracking-wide text-gray-700  mb-2" for="date_of_birth">
    ...
    <div class=" w-26 md:w-28 px-3 mb-6 md:mb-0">
        <label class="block uppercase tracking-wide text-gray-700 mb-2" for="shirt_size">
            ទំហំអាវ
        </label>
    ...
    <div class="md:flex-1 w-1/2  px-3 mb-6 md:mb-0">
        <label class="block uppercase tracking-wide text-gray-700 mb-2" for="position">
            មុខតំណែង
        </label>
        <input
            class="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-300 rounded py-3 px-4 md:mb-8 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
...
<div class="flex flex-wrap -mx-3 mb-2">
    ...
    <div class="md:w-1/3 w-full  px-3 mb-6 md:mb-0">
        <label class="block uppercase tracking-wide text-gray-700 mb-2" for="name">
    ...
    <div class="md:flex-1 w-full px-3 mb-6 md:mb-0 " id="this_is_fucked_up">
        <label class="block uppercase tracking-wide text-gray-700 mb-2" for="acadmedic_year">
            ឆ្នាំទី ឬថ្នាក់
        </label>
