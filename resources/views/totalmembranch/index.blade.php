...
@section('Content')
    ...
    @if(count($total_mem) > 0)
        ...
        <div class="bg-white mt-2 mx-3 shadow-lg">
            ...
            <h2 class="text-center font-siemreap mb-2 text-2xl font-bold"> សាខាកាកបាទក្រហមកម្ពុជា {{$branch_kh}} </h2>
            ...
            <div class="flex justify-between items-center mb-4 mt-14 px-4">
                ...
                <div class="flex items-center space-x-3">
                    <div class="tab_head_container flex items-center space-x-4">
                        ...
                        <div class="year_sort flex items-center space-x-2 font-siemreap text-sm">
