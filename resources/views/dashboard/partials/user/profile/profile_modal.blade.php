<div id="usermodal" class="absolute origin-center left-0 right-0 top-1 hidden">
    <div
        ...
        <div class="p-4 flex items-center justify-content-center border-t mx-8 mt-2">
            ...
            <button id="cancel"
                class="mx-auto rounded-full bg-gray-900 hover:shadow-lg font-semibold text-white px-6 py-2">Cancel</button>
        </div>
    </div>
</div>