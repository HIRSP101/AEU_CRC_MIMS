<div class="flex flex-wrap mx-3 my-3 gap-1">
    ...
    <div class="flex flex-wrap w-full md:w-full md:mb-0 relative">
        ...
        <span class="absolute top-[-3px] left-[250px] font-bold"> {{$member_pob->village ?? ""}}</span>
        <h3 class="px-2">
            ឃុំ/សង្កាត់ ៖
            <span>......................</span>
        </h3>
        <span class="absolute top-[-3px] left-[400px] font-bold"> {{$member_pob->commune_sangkat ?? ""}}</span>
        <h3 class="px-2">
            ស្រុក/ខណ្ទ ៖ <span>.....................</span>
        </h3>
        <span class="absolute top-[-3px] left-[560px] font-bold"> {{$member_pob->district_khan ?? ""}}</span>
        <h3 class="px-2">
            - រាជធានី/ខេត្ត ៖​ <span>..........................</span>
        </h3>
        <span class="absolute top-[18px] left-[120px] font-bold"> {{$member_pob->provience_city ?? ""}}</span>
    </div>
    ...
    <div class="flex w-full md:w-1/3 md:mb-0 relative">
        ...
        <span class="absolute top-[-3px] left-[70px] font-bold"> {{$member_addr->home_no ?? ""}}</span>
    </div>
    <div class="flex w-full md:w-1/3  md:mb-0 relative">
        <h3 class="px-2">
            &ensp; ផ្លូវ​​​ ៖ <span>..................</span>
        </h3>
        <span class="absolute top-[-3px] left-[60px] font-bold"> {{$member_addr->street_no ?? ""}}</span>
    </div>
    <div class="flex w-full md:w-1/4  md:mb-0 relative">
        <h3 class="px-2">
            ភូមិ ៖ <span>...................... </span>
        </h3>
        <span class="absolute top-[-4px] left-[50px] font-bold"> {{$member_addr->village ?? ""}}</span>
    </div>
    <div class="flex w-full md:w-1/4 md:mb-0 relative">
        <h3 class="px-2">
            ឃុំ/សង្កាត់ ៖ <span>....................</span>
        </h3>
        <span class="absolute top-[-4px] left-[80px] font-bold"> {{$member_addr->commune_sangkat ?? ""}}</span>
    </div>
    <div class="flex w-full md:w-1/3  md:mb-0 relative">
        <h3 class="px-2">
            &ensp; ស្រុក/ខណ្ឌ ៖ <span>..........................</span>
        </h3>
        <span class="absolute top-[-4px] left-[100px] font-bold"> {{$member_addr->district_khan ?? ""}}</span>
    </div>
    <div class="flex w-full md:w-1/3 md:mb-0 relative">
        <h3 class="px-2">
            ខេត្ត/រាជធានី ៖ <span>...........................</span>
        </h3>
        <span class="absolute top-[-4px] left-[90px] font-bold"> {{$member_addr->provience_city ?? ""}}</span>
    </div>
    ...
    <div class="flex w-full md:w-full md:mb-0 relative">
        ...
        <span class="absolute top-[-3px] left-[370px] font-bold"> {{$member_edu->acadmedic_year ?? ""}}</span>
    </div>
    <div class="flex w-full md:w-full md:mb-0 relative">
        <h3 class="px-2">
        ...
        <span class="absolute top-[-3px] left-[250px] font-bold"> {{$member_edu->language}}</span>
    </div>
    <div class="flex w-full md:w-full md:mb-0 relative">
        <h3 class="px-2">
        ...
        <span class="absolute top-[-3px] left-[210px] font-bold"> {{$member_edu->major}}</span>
    </div>
    <div class="flex w-full md:w-full md:mb-0 relative">
        <h3 class="px-2">
        ...
        <span class="absolute top-[-3px] left-[430px] font-bold"> {{$member_regis->registration_date}}</span>
    </div>
    <div class="flex w-full md:w-full md:mb-0 relative">
        <h3 class="px-2">
        ...
        <span class="absolute top-[-3px] left-[470px] font-bold"> {{$member_regis->registration_date}}</span>
    </div>
    <div class="flex w-full md:w-full md:mb-0 relative">
        <h3 class="px-2">
            - ថ្ងៃ ខែ ឆ្នាំ ចូលជាយុវជន ស.ស.យ​.ក (UYFC Recruitment Date) ៖ <span>............................</span>
        </h3>
        <span class="absolute top-[-3px] left-[400px] font-bold"> {{$member_regis->registration_date}}</span>
    </div>
    <div class="flex w-full md:w-full md:mb-0 relative">
        <h3 class="px-2">
        ...
        <span class="absolute top-[-3px] left-[480px] font-bold"> {{$member_regis->registration_date}}</span>
    </div>
    <div class="flex w-full md:w-full md:mb-0 relative">
        <h3 class="px-2">
            - វគ្គបណ្ដុះបណ្ដាលទទួលបាន ៖ <span>...........................</span>
        </h3>
        <span class="absolute top-[-3px] left-[180px] font-bold"> {{$member_edu->misc_skill}}</span>
    </div>
    <div class="flex w-full md:w-full md:mb-0 relative">
        <h3 class="px-2">
            - ឈ្មោះសាលារៀន ឬសាកលវិទ្យាល័យ (Name of School or University) ៖ <span>............................</span>
        </h3>
        <span class="absolute top-[-3px] left-[440px] font-bold"> {{$member_edu->institute_id}}</span>
    </div>
    <div class="flex w-full md:w-full md:mb-0 relative">
        <h3 class="px-2">
            - ទំហំ អាវ ៖ <span>.............</span>
