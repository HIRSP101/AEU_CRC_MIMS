import {khmerOSMoulLight , khmerOSSiemreab,logoSVG} from "../../public/js/fontsbase64";

    $("#export_pdf").on("click", async () => {
      try {
        console.log("Generating PDF...");
        pdfMake.createPdf(docDefinition).open(); // Opens the PDF in a new window
        // pdfMake.createPdf(docDefinition).download("sample.pdf"); // Downloads the PDF
      } catch (error) {
...
const svgpath = logoSVG;
let name = "រស់​ រិទ្ធិសភា";
let nameEn = "Ros Rithsakphea";
let birhtday = "២០​ ឪសភា​​ ២០០៤";
let place = "pp";
let home = "23";
let road = "St. 1234";
let village = "កំពងលាវ";
let commune = "កំពងលាវ";
let district = "កំពងលាវ";
let city = "ព្រៃវែង";
let education = "មធ្យមសិក្សាទុតិយភូមិ";
...
//   // pdfMake.createPdf(docDefinition).download("sample.pdf"); // for download
//   pdfMake.createPdf(docDefinition).open(); // preview pdf
// }

export var docDefinition = {
  pageSize: "A4", // You can use "A3", "A5", etc.
...
export function preventEmpty(value) {
...
export function generateCenteredPlaceholders(
  label,
  userInput,
  totalLength,
  placeholderChar = "."
  ...
  return [
    ...
    // get data for name,nameEn
    {
      ...
      columns: [
        {
          margin: [50, 0, 0, 0],
          text: this.preventEmpty(name),
        },
        {
          margin: [80, 0, 0, 0],
          text: this.preventEmpty(nameEn),
        },
        {
          width: "30%",
          text: "",
    ...
    },
    {
      ...
      columns: [
        ...
        },
        {
          ...
          margin: [0, 0, 10, 0],
          stack: [
            this.TUBox(false, 13, 13, 0, 0, [0, 5, 0, 0], "#000000", 0.2),
          ],
        },
        {
          width: "auto",
      ...
      ul: [
        // DOB
        {
          ...
          columns: [
            ...
            {
              text: this.preventEmpty(birhtday),
            },
          ],
        },
        {
        ...
        // address
        {
          ...
          columns: [
            ...
            {
              margin: [80, 0, 0, 0],
              text: this.preventEmpty(home),
            },

            {
              margin: [40, 0, 0, 0],
              text: this.preventEmpty(road),
            },
            {
              text: this.preventEmpty(village),
            },
          ],
        },
        {
        ...
        // address
        {
          ...
          columns: [
            ...
            {
              margin: [70, 0, 0, 0],
              text: this.preventEmpty(commune),
            },

            {
              margin: [60, 0, 0, 0],
              text: this.preventEmpty(district),
            },
            {
              margin: [70, 0, 0, 0],
              text: this.preventEmpty(city),
            },
          ],
        },
        {
        ...
        // Eduction
        {
          ...
          columns: [
            ...
            {
              margin: [50, 0, 0, 0],
              text: this.preventEmpty(education),
            },
          ],
        },
        {
        ...
        // Foreign Language
        {
          ...
          columns: [
            ...
            {
              margin: [50, 0, 0, 0],
              text: this.preventEmpty(foreignLang),
            },
          ],
        },
        {
        ...
        // Life skill
        {
          ...
          columns: [
            ...
            {
              margin: [50, 0, 0, 0],
              text: this.preventEmpty(lifeSkill),
            },
          ],
        },
        {
        ...
        // RCY Recruitment Date
        {
          ...
          columns: [
            ...
            {
              margin: [50, 0, 0, 0],
              text: this.preventEmpty(RCYDate),
            },
          ],
        },
        {
        ...
        // Scout Yout Recruitment Date
        {
          ...
          columns: [
            ...
            {
              margin: [50, 0, 0, 0],
              text: this.preventEmpty(scoutYOuth),
            },
          ],
        },
        {
        ...
        // school name
        {
          ...
          columns: [
            ...
            {
              margin: [50, 0, 0, 0],
              text: this.preventEmpty(schoolName),
            },
          ],
        },
        {
        ...
        // phone number
        {
          ...
          columns: [
            ...
            {
              margin: [50, 0, 0, 0],
              text: this.preventEmpty(phoneNum),
            },
          ],
        },
        {
        ...
        // email and facebook
        {
          ...
          columns: [
            ...
            {
              margin: [50, 0, 0, 0],
              text: this.preventEmpty(emailFaccbook),
            },
          ],
        },
        {
      ...
      ul: [
        // language skill
        {
          ...
          columns: [
            ...
            {
              margin: [50, 0, 0, 0],
              text: this.preventEmpty(langskiil),
            },
          ],
        },
        {
        ...
        // computer skill
        {
          ...
          columns: [
            ...
            {
              margin: [50, 0, 0, 0],
              text: this.preventEmpty(computerSkill),
            },
          ],
        },
        {
        ...
        // other skill
        {
          ...
          columns: [
            ...
            {
              margin: [50, 0, 0, 0],
              text: this.preventEmpty(otherSkill),
            },
          ],
        },
        {
      ...
      ul: [
        // father name and DOB
        {
          ...
          columns: [
            ...
            {
              margin: [50, 0, 0, 0],
              text: this.preventEmpty(dadName),
            },
            {
              margin: [50, 0, 0, 0],
              text: this.preventEmpty(dobDad),
            },
          ],
        },
        {
        ...
        // job
        {
          ...
          columns: [
            ...
            {
              margin: [40, 0, 0, 0],
              text: this.preventEmpty(addressDad),
            },
          ],
        },
        {
        ...
        // mother name and DOB
        {
          ...
          columns: [
            ...
            {
              margin: [50, 0, 0, 0],
              text: this.preventEmpty(momName),
            },
            {
              margin: [50, 0, 0, 0],
              text: this.preventEmpty(dobMom),
            },
          ],
        },
        {
        ...
        // job
        {
          ...
          columns: [
            ...
            {
              margin: [40, 0, 0, 0],
              text: this.preventEmpty(addressMom),
            },
          ],
        },
        {
        ...
        // phone nnumber
        {
          ...
          columns: [
            ...
            {
              margin: [50, 0, 0, 0],
              text: this.preventEmpty(protectorNum),
            },
          ],
        },
        {
