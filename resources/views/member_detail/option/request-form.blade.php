...
<div class="w-[210mm] m-5 h-auto bg-white shadow-lg mx-auto hidden" id="request-form">
    <div style="padding: 60px">
        <div id="pdfMemberRequestContent">
            <div class="head mt-2">
            ...
            <div class="content1 mt-5 font-battambang text-gray-900 text-[18px]">
                ...
                <div class="flex md:mb-0 relative">
                    ...
                    <div>
                        ...
                        <span
                            class="absolute top-[-3px] left-[410px] font-bold">{{$member->current_village ?? ""}}</span>
                    </div>
                    <div>
                        <h3 class="">
                        ...
                        <span
                            class="absolute top-[-3px] left-[570px] font-bold">{{$member->current_commune ?? ""}}</span>
                    </div>
                </div>
                <div class="flex md:mb-0 relative">
                    <div>
                        ...
                        <span
                            class="absolute top-[-3px] left-[75px] font-bold">{{$member->current_district ?? ""}}</span>
                    </div>
                    <div>
                        <h3 class="">
                        ...
                        <span
                            class="absolute top-[-3px] left-[255px] font-bold">{{$member->current_province ?? ""}}</span>
                    </div>
                    <div>
                        <h3 class="">
