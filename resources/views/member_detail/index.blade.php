...
@section('Content')
    ...
    <div class="mr-4 mt-4 mb-4 text-end">
        <button id="clear_btn"
            class="bg-red-500 text-white hover:bg-red-400 font-battambang focus:ring-2 focus:outline-none rounded-xl px-4 py-2 text-center inline-flex items-center justify-between mr-2 mb-2">លុប</button>
        <button
            class="focus:ring-2 bg-green-500 text-white hover:bg-green-400 font-battambang focus:outline-none rounded-xl px-4 py-2 text-center inline-flex items-center justify-between mr-2 mb-2">យល់ព្រម</button>
        <button
            class="word-btn text-white text-[17px] bg-[#4285F4] hover:bg-[#4285F4]/90 focus:ring-2 focus:outline-none rounded-xl px-4 py-2 text-center inline-flex items-center justify-between mr-2 mb-2"
...
@push('JS')
    ...
    <script>
        function exportHTML() {
          ...
          width: 50%;" class="logo" src="{{asset('images/Logo_of_Cambodian_Red_Cross.svg') }}" />
                                </div>
