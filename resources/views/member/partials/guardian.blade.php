...
<div class="flex flex-wrap -mx-3 mb-2 mt-3 ">
    <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
        <label class="block uppercase tracking-wide text-gray-700 mb-2" for="father_name">
            ឈ្មោះឪពុក
        </label>
        <input
            ...
            name="father_name" type="text" id="father_name" required value="{{$newMemberModel->father_name}}">
    </div>
    <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
        ...
        <input
            class="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-300 rounded py-3 px-4 md:mb-8 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
            id="father_dob" name="father_dob" type="date" required value="{{$newMemberModel->father_dob}}">
    </div>
    <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
    ...
    <div class="w-full md:w-full px-3 mb-6 md:mb-0">
        ...
        <input
            class="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-300 rounded py-3 px-4 md:mb-8 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
            name="father_current_address" id="father_current_address" type="text" required value="{{$newMemberModel->father_current_address}}">
    </div>
    <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
        ...
        <input
            class="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-300 rounded py-3 px-4 md:mb-8 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
            name="mother_name" id="mother_name" type="text" required value="{{$newMemberModel->mother_name}}">
    </div>
    <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
        ...
        <input
            class="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-300 rounded py-3 px-4 md:mb-8 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
            name="mother_dob" type="date" id="mother_dob" required value="{{$newMemberModel->mother_dob}}">
    </div>
    <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
        ...
        <input
            class="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-300 rounded py-3 px-4 md:mb-8 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
            name="mother_occupation" type="text" id="mother_occupation" required value="{{$newMemberModel->mother_occupation}}">
    </div>
    <div class="w-full md:w-full px-3 mb-6 md:mb-0">
        ...
        <input
            class="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-300 rounded py-3 px-4 md:mb-8 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
            name="mother_current_address" type="text" id="mother_current_address" required value="{{$newMemberModel->mother_current_address}}">
    </div>
    <div class="w-full md:w-full px-3 mb-6 md:mb-0">
        ...
        <input
            class="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-300 rounded py-3 px-4 md:mb-8 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
            name="guardian_number" id="guardian_number" type="tel" required value="{{$newMemberModel->member_guardian_detail->guardian_phone}}">
    </div>
</div>
