...
class member_guardian_detail extends Model
{
   ...
   protected $fillable = ["mgd_id", "member_id", "father_name", "father_dob", "father_current_address", "father_occupation", "mother_name", "mother_dob", "mother_current_address", "mother_occupation", "guardian_phone"];
