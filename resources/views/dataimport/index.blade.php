...
@canany(['2', '3'])
    @if (auth()->user()->branch_bindding_user[0]->branch == null)
            ...
            <div class="bg-[#fff] rounded-lg max-w-1000px m-5 p-5 shadow-md font-battambang">
                ...
                <div class="mt-14">
                    <div id="loadingSpinner"
                        ...
                        <p id="textduplicate" class="hidden textload text-center font-siemreap">បញ្ចូលជោគជ័យ ប៉ុន្តែមាន Record
                            ស្ទួនចំនួន <span id="duplicateCounter"> </span></p>
                        <p id="textError" class="hidden textload text-center font-siemreap">បញ្ចូលមិនបានជោគជ័យ Record ស្ទួនទាំងអស់
                            សូមជ្រើសរើស sheet ផ្សេងទៀត</p>
                        <div id="spinner" class="spinner hidden"></div>
                        <div id="tick" class="hidden text-center text-green-500 text-6xl">✔</div>
                        <div id="tickWarn" class="hidden text-center text-yellow-500 text-6xl">!</div>
                    ...
                    <div class="flex flex-row gap-4">
                        ...
                        <div class="flex-1">
                            ...
                            <input
                                class=" w-full rounded-md border border-gray-300 py-2 px-3 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 "
                                type="text" disabled id="district">
                        </div>

                        <div class="flex-1">
                            <label for="school"
                                class="font-semibold font-siemreap block text-lg font-medium text-gray-700 mb-1">សាកលវិទ្យាល័យ</label>
                            <input
                                class=" w-full rounded-md border border-gray-300 py-2 px-3 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 "
                ...
                <div id="import-section" class=" mt-5">
                        ...
                        <label for="dropzone-file"
                            ...
                            <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                ...
                                <p class="mb-2 text-sm text-gray-500 dark:text-gray-400 font-siemreap"><span
                                        class="font-semibold font-siemreap">ចុចដើម្បីបញ្ចូល</span></p>
        ...
        @endsection
        @push('JS')
            @vite(['resources/js/import_for_branchhei.js'])
        @endpush
    @else
        @section('Content')
            <div class="bg-[#fff] rounded-lg max-w-1000px m-5 p-5 shadow-md font-battambang">
                ...
                <div class="mt-14">
                    <div id="loadingSpinner"
                        class="fixed top-0 left-0 z-50 w-screen h-screen bg-gray-400 bg-opacity-60 h-full hidden">
                        <p id="textload" class="hidden textload text-center font-siemreap">សូមរងចាំ...</p>
                        <p id="textsucc" class="hidden textload text-center font-siemreap">បញ្ចូលជោគជ័យ</p>
                        <p id="textduplicate" class="hidden textload text-center text-white font-siemreap">បញ្ចូលជោគជ័យ ប៉ុន្តែមាន
                            Record
                            ស្ទួនចំនួន <span id="duplicateCounter"> </span></p>
                        <p id="textError" class="hidden textload text-center text-white font-siemreap">បញ្ចូលមិនបានជោគជ័យ Record
                            ស្ទួនទាំងអស់
                            សូមជ្រើសរើស sheet ផ្សេងទៀត</p>
                        <div id="spinner" class="spinner hidden"></div>
                        <div id="tick" class="hidden text-center text-green-500 text-6xl">✔</div>
