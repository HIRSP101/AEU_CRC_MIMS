...
@section('Content')
    <div class="bg-[#fff] p-8 rounded-lg max-w-1000px m-5 shadow-md font-siemreap">
        ...
        <label class="inline-flex items-center me-5 cursor-pointer">
            <span class="mx-3 text-sm font-medium text-gray-900 dark:text-gray-300">សាខា</span>
            ...
            <span class="ms-3 text-sm font-medium text-gray-900 dark:text-gray-300">អនុសាខា</span>
        </label>
        <ul>
